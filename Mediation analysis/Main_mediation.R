...
File_path = paste(Projcet_path,'Mediate analysis/tbl.csv',sep = '/')

df <- as.data.frame(fread(File_path))
Type1 = read.csv(paste(Projcet_path,'Section/Cluster/Group1/type1_eid.csv',sep = '/'), col.names = 'eid', header = F)
Type2 = read.csv(paste(Projcet_path,'Section/Cluster/Group1/type2_eid.csv',sep = '/'), col.names = 'eid', header = F)
...
X.names<- colnames(df[c(4,7,22,25,27,32)]) # c(4,22,25,27,32)
M.names<- colnames(df[c(38:219)]) # 38:218
Y.names <- colnames(df[220:262]) # 227:269
...
xlsx_path = paste(save_path,'Mediation_Result_Total.xlsx',sep = '/')
write.xlsx(Result_Total, xlsx_path, sheetName = "sheet1", colNames = TRUE, rowNames = TRUE)

xlsx_path = paste(save_path,'Mediation_Result_Type1.xlsx',sep = '/')
write.xlsx(Result_Type1, xlsx_path, sheetName = "sheet1", colNames = TRUE, rowNames = TRUE)

xlsx_path = paste(save_path,'Mediation_Result_Type2.xlsx',sep = '/')
